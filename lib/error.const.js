...
const userExist = {
    httpCode: 403, error: { code: 2,  subCode: 1,  message: 'User exists (email address already in use)'}
};

const pseudoExist = {
    httpCode: 403, error: { code: 2,  subCode: 2,  message: 'User exists (pseudo already in use)'}
};
...
const schemaValidationError = {
    httpCode: 500, error: { code: 2, message: 'Validation Error\n'}
};
